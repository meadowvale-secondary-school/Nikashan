 ...
 */
var Nikashan = User(name: "Nikashan", age: 16, height: 71, weight: 190, activityLevel: 6)
print("Name: \(Nikashan.name), Age: \(Nikashan.age), Height: \(Nikashan.height) inches, Weight: \(Nikashan.weight) lb, Activity Level: \(Nikashan.activityLevel)")
/*:
 ...
 */
var someDistance = Distance(feet: 600)
print(someDistance.feet)
print(someDistance.meters)
