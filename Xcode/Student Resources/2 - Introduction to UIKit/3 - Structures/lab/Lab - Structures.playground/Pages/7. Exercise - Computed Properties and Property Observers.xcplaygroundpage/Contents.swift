...
struct Height {
    var heightInInches: Double{
        didSet {
            let newCenti = heightInInches*2.54
            if heightInCentimeters != newCenti {
                heightInCentimeters = newCenti
            }
        }
    }
...
var someHeight = Height(heightInInches: 71)
print(someHeight.heightInCentimeters)
someHeight.heightInInches = 80
print(someHeight.heightInCentimeters)
